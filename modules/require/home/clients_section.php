<section class="clients-section sec-padd">
    <div class="container">
        ...
        <div class="client-carousel owl-carousel owl-theme">
            ...
            <div class="item tool_tip" title="Eunique Capital Investments">
                <img src="images/clients/1.png" alt="Awesome Image">
            </div>
            <div class="item tool_tip" title="Kitambulisho.com">
                <img src="images/clients/2.png" alt="Awesome Image">
            </div>
            <div class="item tool_tip" title="Reflex Concepts Limited">
                <img src="images/clients/3.png" alt="Awesome Image">
            </div>
            <div class="item tool_tip" title="Geosolutions International(K)">
                <img src="images/clients/4.png" alt="Awesome Image">
            </div>
            <div class="item tool_tip" title="Ogelea Africa">
