<section class="consultations sec-padd" style="background-image: url(images/background/banner1.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12">   
                <div class="contact-info">
                    ...
                    <div class="widget-content">
                        <ul class="list-info">
                            <li><span class="fa fa-phone"></span>Phone:(+254) 723 209072</li>
                            <li><span class="fa fa-envelope"></span>Email: euniquecapital@gmail.com</li>
                            <li><span class="fa fa-clock-o"></span>Mon to Sat: 9.00am to 5.00pm</li>
                        </ul>
                    </div>
                </div>
            </div>
